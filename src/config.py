...
LGBM_PARAMS = [
    ...
    {"learning_rate": 0.05, "n_estimators": 400, "max_depth": 8, "num_leaves": 60},
    # Run 2: Shallower trees, slower learning rate (often robust)
    {"learning_rate": 0.02, "n_estimators": 500, "max_depth": 5, "num_leaves": 20},
    # Run 3: A more aggressive, faster-learning model
    {"learning_rate": 0.1, "n_estimators": 200, "max_depth": 6, "num_leaves": 40},
]
